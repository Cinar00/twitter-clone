...
const Sidebar = () => {
  ...
  return (
    <div className="h-screen sticky top-0 flex flex-col justify-between w-72 px-2">
      <div>
        <div className="mt-1 mb-4 ml-1 flex items-center justify-center w-12 h-12 rounded-full hover:cursor-pointer hover:bg-gray-lightest transform transition-colors duration-100">
          <img src={twitterLogo} alt="Twitter Logo" className="w-9 h-9" />
        </div>

        <nav className="mb-4 cursor-pointer">
          <ul>
